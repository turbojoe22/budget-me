<template>
  ...
  <div id="page">
    ...
    <p>
      ...
      like and see your expenses in real time. You will also have the chance to add any up coming expenses or create expenses
      to see how it will effect your budget.
    </p>
  </div>
</template>
